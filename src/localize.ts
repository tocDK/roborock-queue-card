...
const translations: Record<string, Record<string, string>> = {
  da: {
    ...
    // Dock diagnostics
    'dock.clean_water_box': 'Ren vandbeholder',
    'dock.dirty_water_box': 'Beskidt vandbeholder',
    'dock.dock_error': 'Dock fejl',
    'dock.mop_drying': 'Moppe tørring',
    'dock.mop_drying_time': 'Moppe tørretid',
  ...
  en: {
    ...
    'dock.clean_water_box': 'Clean water box',
    'dock.dirty_water_box': 'Dirty water box',
    'dock.dock_error': 'Dock error',
    'dock.mop_drying': 'Mop drying',
    'dock.mop_drying_time': 'Mop drying time',
